...
\huge  E13 Reinforcement Learning (C++/Python)\\ % The assignment title
...
\begin{enumerate}
	...
	\end{figure}
	\item Please submit a file named \texttt{E13\_YourNumber.pdf} and send it to \texttt{ai\_course2021@163.com}
\end{enumerate}
